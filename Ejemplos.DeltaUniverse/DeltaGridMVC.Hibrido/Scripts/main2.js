...
function AbrirDocumento(tipo,nombre) {
    $("#doc").modal('show');
    var injector = angular.injector(['ng','DeltaGridComun']);
    var comun = injector.get("DGComunService");
    var $http = injector.get("$http");
    
    var req = {
        url: '/Vista/Codigo?tipo=cshtml&nombre=test.cshtml',
        headers: {
            'content-Type': 'text',
            "Accept": "text"
        }
